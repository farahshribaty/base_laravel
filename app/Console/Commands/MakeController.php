...
class MakeController extends Command
{
    ...
    public function handle()
    {
        ...
        use App\Http\Resources{{NAMESPACE}}\Delete{{NAME}}Resource;
        use App\Http\Resources{{NAMESPACE}}\GetAll{{NAME}}Resource;
        use App\Http\Resources{{NAMESPACE}}\GetOne{{NAME}}Resource;
        use App\Http\Resources{{NAMESPACE}}\Update{{NAME}}Resource;
        use App\Http\Resources{{NAMESPACE}}\Create{{NAME}}Resource;
        ...
        Artisan::call('make:resource', ['name' => "{$fill_path_with_last_name}/Create{$name}Resource"]);
        
        
        // Update Function
        Artisan::call('make:custom-request', ['name' => "{$fill_path_with_last_name}/Update{$name}"]);
        Artisan::call('make:resource', ['name' => "{$fill_path_with_last_name}/Update{$name}Resource"]);
        
        
        // Delet Function 
        Artisan::call('make:custom-request', ['name' => "{$fill_path_with_last_name}/Delete{$name}"]);
        Artisan::call('make:resource', ['name' => "{$fill_path_with_last_name}/Delete{$name}Resource"]);
